...
def setup_optimization(args, model, trainable_params, param_groups, id_galore_params):
    ...
    elif args.optimizer.lower() == "self_adamw":
        optimizer = GaLoreAdamW(trainable_params, lr=args.lr, weight_decay=args.weight_decay)
    elif args.optimizer.lower() == "galore_adamw":
        optimizer = GaLoreAdamW(param_groups, lr=args.lr, weight_decay=args.weight_decay)
    elif args.optimizer.lower() == "sam":
        base_optimizer = torch.optim.AdamW
        optimizer = SAM(trainable_params, base_optimizer, lr=args.lr, rho=args.rho, precond=args.precond)
    elif args.optimizer.lower() == "function_sam":
        base_optimizer = torch.optim.AdamW
        optimizer = FunctionalSAM(trainable_params, base_optimizer, lr=args.lr, rho=args.rho, precond=args.precond)
